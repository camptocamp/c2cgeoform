...
from sqlalchemy import BigInteger, Boolean, Column, Date, ForeignKey, Integer, Table, Text
from sqlalchemy.orm import relationship
from {{cookiecutter.package}}.i18n import _
from {{cookiecutter.package}}.models.meta import Base

from c2cgeoform.ext import colander_ext, deform_ext
from c2cgeoform.ext.deform_ext import RelationSearchWidget, RelationSelect2Widget, RelationSelectMapWidget
...
class Excavation(Base):
    ...
    location_position = Column(
        geoalchemy2.Geometry('POINT', 4326), info={
            'colanderalchemy': {
                'title': _('Position'),
                'typ':
    ...
    work_footprint = Column(
        geoalchemy2.Geometry('MULTIPOLYGON', 4326),
        info={
            'colanderalchemy': {
...
class BusStop(Base):
    ...
    name = Column(Text)
    geom = Column(geoalchemy2.Geometry('POINT', 4326))
